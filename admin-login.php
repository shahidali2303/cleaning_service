              ...
              <div class="main-menu__wrapper-inner">
                ...
                <div class="main-menu__main-menu-box">
                  ...
                  <ul class="main-menu__list">
                    ...
                    <li>
                      <a href="contact.html">Job Board</a>
                    </li>
                    <li class="dropdown">
                      ...
                      <ul class="shadow-box">
                        ...
                        <li>
                          <a href="#">Ironing service</a>
                        </li>
                        <li>
                          <a href="#">Washing Vehicles</a>
                        </li>
                        <li>
                          <a href="#">Gardening</a>
                        </li>
                        <li>
                          <a href="#">House Maintenance</a>
                        </li>
                      </ul>
                    </li>
                ...
                <div class="main-menu__right">
                  <div class="main-menu__btn-box">
                    <div class="main-menu__btn">
                      <a href="contact.html">
                        <span class="icon-customer-support"></span> Recent Job
                        Available</a
                      >
                    </div>
                  </div>
          ...
          <div class="login-one__form">
            ...
            <!-- <form action="register.php" method="post">
              <div class="row">
                ...
                <div class="col-xl-12">
                  <div class="form-group">
                    <button class="thm-btn" type="submit">Register</button>
                  </div>
                </div>
              </div>
            </form> -->
                ...
                <div class="col-xl-5">
                  <div class="site-footer-two__top-left">
                    <div class="site-footer-two__logo-box">
                      ...
                      <p class="site-footer-two__text-1">
                        We are passionate about delivering exceptional cleaning
                        <br />
                        services to create spotless, comfortable spaces for
                        homes <br />
                        and businesses.
                      </p>
                    </div>
                      ...
                      <div class="row">
                        ...
                        >
                          <div class="footer-widget-two__quick-links">
                            <h4 class="footer-widget-two__title">
                              Quick Links
                            </h4>
                            <ul
                              class="footer-widget-two__quick-links-list list-unstyled"
                            >
                              <li>
                                <a href="index.html">
                                  <span class="icon-next"></span> Home</a
                                >
                              </li>
                              <li>
                                <a href="about.html">
                                  <span class="icon-next"></span> About Us</a
                                >
                              </li>
                              <li>
                                <a href="contact.html">
                                  <span class="icon-next"></span> Contact</a
                                >
                              </li>
                              <li>
                                <a href="faq.html">
                                  <span class="icon-next"></span> FAQs Page</a
                                >
                              </li>
                              <li>
                                <a href="blog.html">
                                  <span class="icon-next"></span> Our Blogs</a
                                >
                              </li>
                            </ul>
                          </div>
                        ...
                        >
                          <div class="footer-widget-two__essential-links">
                            <h4 class="footer-widget-two__title">Essential</h4>
                            <ul
                              class="footer-widget-two__quick-links-list list-unstyled"
                            >
                              <li>
                                <a href="about.html">
                                  <span class="icon-next"></span> Our Company</a
                                >
                              </li>
                              <li>
                                <a href="about.html">
                                  <span class="icon-next"></span> Terms &
                                  Condition</a
                                >
                              </li>
                              <li>
                                <a href="about.html">
                                  <span class="icon-next"></span> Privacy
                                  Policy</a
                                >
                              </li>
                              <li>
                                <a href="contact.html">
                                  <span class="icon-next"></span> Contact Us</a
                                >
                              </li>
                              <li>
                                <a href="about.html">
                            ...
                            >
                              <li>
                                <a href="office-cleaning.html">
                                  <span class="icon-next"></span> Office
                                  Cleaning</a
                                >
                              </li>
                              <li>
                                <a href="commercial-cleaning.html">
                                  <span class="icon-next"></span> House
                                  Cleanings</a
                                >
                              </li>
                              <li>
                                <a href="sanitizing-mopping.html">
                                  <span class="icon-next"></span> Store
                                  Moping</a
                                >
                              </li>
                              <li>
                              ...
                              <li>
                                <a href="deep-cleaning.html">
                                  <span class="icon-next"></span> Room
                                  Sparkling</a
                                >
                              </li>
                            </ul>
      ...
      <div class="mobile-nav__content">
        ...
        <ul class="mobile-nav__contact list-unstyled">
          <li>
            ...
            <a href="mailto:needhelp@packageName__.com">needhelp@Shahid.com</a>
          </li>
          <li>
